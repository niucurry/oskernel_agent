"""segment 模块 CLI：
  ...
  python -m oskernel_agent.comparison.segment --suspects data/output/xxx_suspects.json
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog="python -m oskernel_agent.comparison.segment", description="函数内分段向量验证。")
