"""桥接层：用本仓库 `oskernel_agent.comparison.normalize` 的 tree-sitter 解析器抽取函数，转成上游 FunctionBlock。
...
from oskernel_agent.comparison.normalize.discovery import discover_files
