"""report 模块 CLI：
  ...
  # 语义级对比报告（与 python -m oskernel_agent.comparison.pipeline 内部走同一函数，格式完全一致）
  ...
  python -m oskernel_agent.comparison.report gitlab-heads
"""
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog="python -m oskernel_agent.comparison.report", description="查重对比报告生成。")
