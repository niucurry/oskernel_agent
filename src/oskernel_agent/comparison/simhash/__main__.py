"""simhash 模块 CLI：
  ...
  python -m oskernel_agent.comparison.simhash build [--db data/db/functions.db]
  python -m oskernel_agent.comparison.simhash query --repo <仓库路径>      # 报告每函数 SimHash 召回候选数
"""
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog="python -m oskernel_agent.comparison.simhash", description="SimHash 函数粗筛层。")
