"""exact 模块 CLI：
  ...
  python -m oskernel_agent.comparison.exact verify --recall data/output/xxx_recall.json
"""
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(prog="python -m oskernel_agent.comparison.exact", description="精确比对与嫌疑对生成。")
